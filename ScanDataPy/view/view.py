...
class QtDataWindow(QtWidgets.QMainWindow):
    ...
    def open_file(self, filename_obj=None):
        ...
        self.__main_controller.create_default_controller(0)  # make user controllers 
        self.__main_controller.set_user_controller_keys_to_manager()
        ...
        self.__main_controller.set_key('controller_name_dict', 'ROI0', False)
        self.__main_controller.set_key('controller_name_dict', 'ImageController1', False) 
        self.__main_controller.set_key('controller_name_dict', 'ElecTraceController1', False) 

        #self.__main_controller.set_view_flag("FLUO_AXES", "ROI0", "CH1", True)  # This is for showing ROI0 data.
        
        self.__main_controller.show_data({'Attribute':'Data'}, {'Origin':'File'}) # target dict and expect dict
